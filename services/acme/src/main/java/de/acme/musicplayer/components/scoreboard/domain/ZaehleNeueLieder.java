...
@Slf4j
public class ZaehleNeueLieder implements ZaehleNeueLiederUsecase {

    private final UserScoreBoardPort userScoreBoardPort;
    private final EventPublisher scoreboardEventPublisher;

    public ZaehleNeueLieder(UserScoreBoardPort userScoreBoardPort, EventPublisher scoreboardEventPublisher) {

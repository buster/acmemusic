...
- **MCP tool usage**: Atlassian/Confluence/Jira, Search, Fetch, and other MCP tools
- **Technical research**: External sources, documentation, best practices
- **Documentation analysis**: Contents in `docs/`, `agent/docs/`, and other documentation directories

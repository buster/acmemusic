...
. Event Bibliothek [❓]
.. Events als API in eigener Bibliothek
...
Spring Native::
getestet und verworfen, siehe xref:documentation/ADRs/01-spring-native.adoc[Spring Native].
...
- xref:documentation/ADRs/02-testing-framework.adoc[Testing Framework]
- xref:documentation/ADRs/03-persistenzframework.adoc[Persistenz Framework]
